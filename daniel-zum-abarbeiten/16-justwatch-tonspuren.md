...
Stand: 2026-09-10. Erzeugt von `npm run data:justwatch`.
...
2 offene Verweise, zu denen JustWatch eine Tonspur nennt.

| Titel | Anbieter | JustWatch sagt | Tonspuren | Quelle |
|---|---|---|---|---|
| [Digimon](https://anime-kalender.de/#/datenbank?t=552) | primevideo | 🇩🇪 **Deutsch dabei** | `de` | [JustWatch](https://www.justwatch.com/de/Serie/Digimon-Digital-Monsters) |
| [Okko und ihre Geisterfreunde](https://anime-kalender.de/#/datenbank?t=101478) | crunchyroll | 🇩🇪 **Deutsch dabei** | `de, ja` | [JustWatch](https://www.justwatch.com/de/Film/Okkos-Inn) |

## Titel ganz ohne Bezugsweg

2 Titel im Hauptbestand haben keinen einzigen Weg — hier nennt JustWatch einen.
