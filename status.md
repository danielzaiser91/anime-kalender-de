...
| **YouTube: 24 Verweise ohne Sprachangabe** (gemessen 23.08.2026, 02:05) | 2 | Alle 93 wurden am 23.08.2026 geprueft — erst ueber oEmbed (Titel und Kanal), dann ueber die JSON-Fracht der Videoseite, die die Tonspur strukturiert nennt. **41 Verweise sagen ihre Fassung selbst**, 40 davon deutsch; dazu sechs, deren Videotitel sie benennt. Kein Verweis ist geloescht, neun sind kostenpflichtig (HTTP 401 bei oEmbed, Kauf- und Leihfilme). Die uebrigen 46 nennen nichts — dort haette nur die Data API mit Schluessel eine Antwort, und die kostet Kontingent. Reste in `data/youtube-pruefliste.md` |
...
| **Prüfliste „Wo läuft es" abarbeiten** (Dauerauftrag) | — | **872 Anbieter-Verweise ohne Sprachangabe (gemessen 23.08.2026, 02:05 aus `public/data/titles.json`)** — heruntergearbeitet von 1.732 am 22.08. Verteilung: Crunchyroll 523, Prime Video 243, Disney+ 40, Netflix 33, YouTube 24, ADN 7, Joyn 2, RTL+ 0. **Belegt sind 1.010 von 1.882 Verweisen:** Crunchyroll 445, Netflix 342, ADN 121, YouTube 50, RTL+ 40, Disney+ 7, Prime 5. Der Crunchyroll-Anteil laeuft maschinell nach (Montags-Durchlauf), Netflix ist mit der Erweiterung fast durch. **Die Zahlen hier werden gemessen, nicht fortgeschrieben** — Griff: `node -e` ueber `public/data/titles.json`, `streams[].dub` |
