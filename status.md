...
| **Offen: 619 Amazon-Verweise stehen in der Linkprüfung auf „unklar“** | 2 | Gezählt am 17.09.2026 in `data/link-check.json` (559 vom 07.09., 40 vom 14.09., 20 vom 09.09.). Amazon sperrt den Wochenlauf (`data:links --limit 400`) nach einigen hundert Abrufen; tote Seiten bleiben so wochenlang als Pille stehen (Pokémon S&W Staffel 2, `B0CGRCT6M2`, von Daniel gemeldet). Zu klären: die unklaren Amazon-Adressen zuerst und in kleineren Portionen prüfen, statt sie hinter 400 andere Adressen zu stellen |
