...
| Aufgabe | SP | Notiz |
| **Erledigt am 26.09.2026: Poster-Design umgesetzt und live (PR #244)** | 13 | Woche/Monat, Kopfleiste, Filterfeld, Abo-Knopf, Staffelfinale, Handy-Leiste; Agenda/Favoriten/„Wo sehen?“ entfallen (Weiterleitung), „gesehen bis“ im Panel. Zwei Runden mit einem Prüf-Agenten bis „zufrieden“. Details: `docs/wissen/datensatz.md`, „Poster-Gestaltung“. Offen und älter als der Umbau: Datenbank, Detail-Panel und Quellen tragen noch die alte Optik samt axe-Kontrastfehlern (`node tools/a11y-pruefen.mjs --kontrast`), Datenbank zählt 3.690 Anime gegen 2.777 im Fuß. |
