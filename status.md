...
| **Durchgang (pausiert)** | — | Zuletzt 19.09.2026, 19:22: Netflix 1/1, Suchadresse 1/1, Prime ohne Urteil 1/4 erledigt (Fushigi New OVA: kein Deutsch, Beleg Crunchyroll-API), als Nächstes „Haikyu!!" (Schritt 4). Schritte in `daniel-zum-abarbeiten/00-durchgang-schritte.md`. Fortsetzen mit `/ai-daniel-todos` |
