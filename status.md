...
| **Offen: Staffelzuordnung über Titel statt Folgenzahl (Netflix)** | 3 | Daniel, 18.09.2026: „warum so hart an episodenzahl gekoppelt? episodentitel sind viel eindeutiger, kombination aus allen verfügbaren informationen am eindeutigsten.“ Anker: Folgentitel (Netflix-Meldung trägt ihn in der Notiz, TMDB je Staffel in `data/tmdb-folgen.json`), Staffelnamen im Netflix-Auswahlfeld (Selektor erst messen), Kennungen. Vorher über den Bestand messen, wie oft Netflix- und TMDB-Titel übereinstimmen. |
| **Offen: Prüfliste — ein Werk bleibt offen, bis jede Staffel gemeldet ist** | 2 | Daniel an Jormungand: Der Auftrag verschwand nach Staffel 1, Perfect Order hing daran. Seit 28.08. führt die Liste Werke, nicht Staffeln; sie muss dann aber zählen, welche Staffeln der Serienseite noch fehlen. |
| **Offen: Jormungand-Einträge aus `verweise-von-hand.yaml` nehmen** | 1 | Beide Prime-Seiten „laut Seite nicht mehr im Abo", kein Kauf, nicht in der Suche. |
