...
| **Die drei Haikyu-Meldungen vom 22.08. neu zuordnen** | 1 | S2 E26 (id 284) liegt als Handbeleg bei der Hauptstaffel 20992 statt bei der OVA 21348, S4 E1/E27 (315/316) als „Folgen 1–27" bei 106625. Beide Zuordnungen stammen aus der Zeit vor der kumulativen Rechnung |
| **1.489 identische Doppel in `dub-confirmed.yaml`** | 2 | Gemessen 11.09.2026: 3.289 Belege, 136 davon mehrfach, zusammen 1.489 Zeilen zu viel (1.456 Netflix, 20 Disney+, 13 Prime). Welcher Lauf sie anhängt, ist ungemessen |
| **Folgen-Metadaten vollständig mitschicken** | 2 | Daniel, 11.09.2026: „alle folgen maximal mögliche infos sammeln, also ep titel sehr wichtig für zuordnung später, besonders wegen ova. auch runtime und release date und original release date". Was Netflix' Folgenliste und Player je Folge liefern, geht in jede Meldung |
