...
| **Queue: Tavilys 404 gegen eine freie Leitung gegenprüfen (20.09.2026)** | 1 | Zehn `/dp/`-Adressen aus unserer „unklar"-Liste kamen über Tavily als „404 page not found", die Video-Adressen derselben ASINs lebten (Space Dandy, Anti-Magic Academy). Bevor Tavily-Befunde in den Bestand dürfen, wird an denselben Adressen lokal gegengeprüft, sobald Amazon wieder offen ist. „Error fetching content" von Tavily zählt wie unser `unklar` und setzt nie einen Befund. |
