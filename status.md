...
| **Queue (26.09.2026): Laufende Synchro bei Handbelegen erneut vorlegen** | 3 | Snowball Earth stand bei Disney+ seit dem 20.09. auf „deutsch 1–2, 3–13 nein“, Daniel sah am 26.09. deutsch bis Folge 6. Ein Handbeleg mit `dub: false` am Ende friert eine wöchentlich erscheinende Synchro ein: Der Titel fällt aus der Prüfliste, und die Erweiterung zeigt „alles gemeldet“. Vorschlag: Belege, deren letzter Bereich `dub: false` ist und deren erster deutsch, nach sieben Tagen automatisch über `tools/erneut-melden.mjs` zurück auf die Prüfliste (Netflix, Prime, Disney+). |
