...
| **In Arbeit (25.09.2026): Weitere News-Quellen prüfen** | 3 | Daniel: „vergleich … news seiten mit unserem bestand, nur wenn es news sind die früher, besser oder anders sind … dann könnte sich die anbindung lohnen". Heute läuft nur Anime2You (RSS → Vorschläge, `data/proposals/anime2you.json`), und die Vorschläge werden nicht eingearbeitet |
