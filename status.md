...
| **Queue (26.09.2026): Disc-Termin aus den News mit der aniSearch-Ausgabe verknüpfen** | 3 | Daniel am 26.09.2026 zu Entscheidung 4: Der Termin 20.11.2026 (Anime2You, `auto-813-disc`) ist Dragon Ball Z Box 4 als Blu-ray, bestätigt auf der Amazon-Seite B0HGB666NM. In `data/disc-ausgaben.json` steht dieselbe Box mit Platzhalter 31.12.2026. Umsetzen: Zuordnung über Titel und Boxnummer (News-Adresse `…box-4…` ↔ `Box 04/10`), die Ausgabe übernimmt das Datum aus der News, der Termin Name und Link der Ausgabe; Zusicherung, dass kein fremder Titel und keine fremde Box zugeordnet wird. Hängt mit „Anime2You-Vorschläge einarbeiten“ zusammen (55 verschobene Blu-ray-Termine). |
