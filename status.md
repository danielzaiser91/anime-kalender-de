...
| **Offen: 339 Amazon-Verweise ohne Linkbefund — lokal messen** | 2 | Stand 20.09.2026, 14:00 (gezählt in `data/link-check.json`): 1.730 Amazon-Adressen, davon 1.338 mit 200, 42 Regionssperre, 10 mit 503, 1 mit 404, **339 unklar** (vorher 472). Aus der Cloud sperrt Amazon nach wenigen Dutzend Abrufen, lokal nach rund 670 — der vierte Schub kam auf 671 geprüfte Verweise und brach dann ab. Vorgehen: `npx tsx pipeline/check-links.ts --alter 3 --limit 1000` über Daniels Leitung, mit etwa einer Stunde Abstand zwischen den Schüben. |
