...
| **Crunchyroll: 17 im Lauf offen, 28 im Datensatz — die Differenz ist die Nachrunde** | 3 | Der Lauf `fetch-crunchyroll-offene.ts` meldet am 09.09.2026 abends: 1 über die Videokennung, 2 über den Katalog, **8 tote Adressen**, 17 offen. Der ausgelieferte Datensatz zeigt 28 — die Differenz sind Verweise, die **im Bau selbst** entstehen: Die aniSearch-Nachrunde ergänzt Anbieter, nachdem der Lauf `titles.json` gelesen hat, und die neuen Verweise haben naturgemäß kein Urteil. Sie klären sich beim nächsten Durchgang; **zu prüfen bleibt, ob sie es wirklich tun** oder ob hier eine Runde fehlt. **Was echt offen ist:** 8 Adressen zeigen auf die **Reihe** statt aufs Werk (Free!-Filme, Chunibyo-OVA), 2 auf mehrdeutige Staffeln, 3 haben keine zweite Quelle. Drei Wege sind heute gebaut und tragen: Slug → Serienkennung, Filmeintrag = Werk, einstimmige Staffeln brauchen keine Zuordnung |
