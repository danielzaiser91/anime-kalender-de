...
| **Durchgang (pausiert)** | — | Zuletzt 19.09.2026, 19:22: Netflix 1/1, Suchadresse 1/1, Prime ohne Urteil 1/4 erledigt (Fushigi New OVA: kein Deutsch, Beleg Crunchyroll-API), Haikyu!! erledigt (falscher Staffel-1-Verweis auf die Seite von Staffel 2 entfernt), Grisaia: TV-Serie 145740 kein Deutsch, Film B0GX7DVSXM gehört zu 99470 statt Stargazer, Erweiterung las Altersfeld „18“ als Staffelzahl (4.20.30), Edens Zero S2 kein Deutsch (In Prime enthalten, Français/日本語). Als Nächstes D: 14 JustWatch-Kandidaten. Schritte in `daniel-zum-abarbeiten/00-durchgang-schritte.md`. Fortsetzen mit `/ai-daniel-todos` |
| **Queue: Erweiterung ohne Melde-Kasten auf der gti-Seite (Daniel, 19.09.2026)** | 2 | Edens Zero S2, `amazon.de/gp/video/detail/0KXOMCNFCKPTA6Z6HNIJ0ESQ9P`: nur „1 Prime-Suchen offen", kein Befund, kein Melden — der Auftrag steht unter B0D956JD5Y. Die Seite sollte ihren Auftrag über die Seitenadresse finden. Nach dem Durchgang. |
| **Queue: Erweiterung zeigt zu wenig für Staffel-/OVA-Entscheidungen (Daniel, 19.09.2026)** | 2 | Bei „Fushigi Yugi OVA" (Prime: Staffel 1 = TV-Serie, Staffel 2 = beide OVAs) fehlte im Kasten der aniSearch-Link und die Folgenzahl unseres Titels, um zu sehen, welche Staffel gemeint ist. Nach dem Durchgang. |
...
| **Queue: Erweiterung erkennt „nicht bei Netflix" nicht (Daniel, 19.09.2026)** | 2 | Eine Titeladresse, die auf `/browse` umleitet (Bakugan 81659233), zeigte nur „Alles gemeldet" — die Erweiterung müsste den Auftrag erkennen und „nicht bei Netflix" melden lassen. Nach dem Durchgang. |
