...
| Aufgabe | SP | Notiz |
| **Offen (25.09.2026): Prime-Durchgang liest Staffeln mit einem Abschnitt im Hintergrund** | 5 | Daniels Ja nach dem PoC (Ton 31/31, Abschnittszahl 31/31, siehe `docs/wissen/erweiterung.md`). Erst den Aufbau der Meldung aus dem Klick-Handler in `amazon.js` herauslösen, dann Hintergrundweg; erster Lauf mit Vergleich gegen die Knopf-Meldungen |
...
| Aufgabe | Notiz |
|---|---|
| **Prime-Durchgang — erster Lauf durch, jetzt 4.22.9 (25.09.2026)** | Lauf 15:13–15:35 UTC: alle 5 Titel, 102 Staffelseiten gemeldet (Naruto 9, Pokémon 57 Bände, Advanced Generation 15, Diamant & Perl 15, Yu-Gi-Oh! 6), ein Hänger (4.22.8 behoben). Rund 10 s je Seite, die Hälfte eigene Wartezeit (4.22.9 streicht sie). Bände gingen mit `staffel` 201, 1001 … raus — nach dem nächsten Bestandslauf prüfen, wie der Zuordner sie legt. PoC „Staffel im Hintergrund lesen" läuft (`tools/prime-hintergrund-poc.mjs`). Dazu am selben Tag: Netflix-Randprobe in Stapeln zu zehn (4.22.4), Film-Einträge im Durchgang (4.22.5, Steel Ball Run gemeldet), Zähler je Staffel mit einer Folge (4.22.6) |
