...
| **Offen: 618 Amazon-Verweise stehen in der Linkprüfung auf „unklar“** | 2 | Gezählt am 17.09.2026 in `data/link-check.json`. Ursache gemessen: Aus der Cloud sperrt Amazon nach wenigen Dutzend Abrufen (14.09.: 2 Befunde, dann Sperre); brauchbare Befunde kamen nur vom lokalen Lauf am 07.09. (552). Behoben am 17.09.: Die Sperre brach den ganzen Wochenlauf ab, sodass seit dem 07.09. auch andere Anbieter ungeprüft blieben — jetzt überspringt der Lauf nur Amazon. **Wartet auf Daniel:** ob Amazon-Adressen in Portionen von hier geprüft werden dürfen (Amazons robots.txt sperrt 19 Bots namentlich, siehe CLAUDE.md „Amazon duldet keinen Agenten") oder nur über die Erweiterung als „nicht abrufbar" gemeldet werden |
