...
| **15 Belege mit Anbieterzählung neu zuordnen** | 2 | Stand 11.09.2026, 14:00: von 24 sind neun berichtigt (BAKI-DOU, Sailor Moon Eternal, Dr. STONE RYUSUI/New World/Part 2, Kabaneri Unato, KONOSUBA 2 → OVA 97996, KONOSUBA 3 + BONUS STAGE, MHA S7). Offen: **FGO Babylonia** (Netflix 22 = 21 + Episode 0 — vorn oder hinten?) und **SHIBOYUGI** (Netflix 12, AniList 11) — beides entscheiden die Folgentitel, die seit 4.19.3 mitkommen; dazu 9 Prime und 3 Disney+, deren Aufteilung wir nicht gespeichert haben. `check:logic` hält die Zahl bei 15 |
