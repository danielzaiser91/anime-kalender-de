...
| **Offen: 472 Amazon-Verweise ohne Linkbefund — lokal messen** | 2 | Stand 20.09.2026 (gezählt in `data/link-check.json`): 1.730 Amazon-Adressen, davon 1.213 mit 200, 37 Regionssperre, 8 mit 503, **472 unklar**. Aus der Cloud sperrt Amazon nach wenigen Dutzend Abrufen. Daniel hat am 20.09.2026 „lokal messen" gewählt: in kleinen Schritten über seine Leitung, mit Abstand zwischen den Abrufen (`npx tsx pipeline/check-links.ts --limit …`, 700 ms Pause, Abbruch nach 20 Zwischenseiten in Folge). |
