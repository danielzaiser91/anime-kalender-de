...
| **Stichprobe: Haben westliche Animationsserien überhaupt einen deutschen Termin?** | 2 | Die eine Messung, an der die Cartoon-Entscheidung hängt (siehe Zeile darüber und `docs/analyse-cartoons.md`, Abschnitt 7). Hundert Titel aus TMDBs Liste der 778, je Titel `watch/providers` für DE plus die Sprachangaben aus den Quellen, die wir für Netflix, Disney+ und Prime ohnehin nutzen. Gefragt ist **nicht** „gibt es eine deutsche Fassung" — die gibt es fast immer —, sondern „gibt es sie später als das Original oder gar nicht". Fällt die Antwort auf „fast alle sofort deutsch", ist die Erweiterung ein Kalender ohne Auskunft, und es bleibt beim erklärenden Hinweis in der Suche |
