...
| Aufgabe | SP | Notiz |
|---|---|---|
| **Bereichsmeldung: Daniels Gegenprobe steht aus** | 1 | Am 07.09.2026 geprüft, was ohne seine Sitzung prüfbar ist: Das CSS trägt (`npm run check:leiste` misst Feld und Knopf nebeneinander, sichtbar, nichts darüber), und die Logik ebenso (`tools/melder-leiste-pruefen.cjs`, sechs Zusicherungen — der Zweig legt beide an, schaltet sie sichtbar, hängt den Knopf ans Feld, und beim Abräumen der Leiste werden beide Referenzen genullt). **Die wahrscheinlichste Erklärung für seine Beobachtung: Er war im Player**, wo die Leiste bauartbedingt abgeräumt wird. Offen ist die Gegenprobe auf der Titelseite |
