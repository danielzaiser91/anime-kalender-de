...
| **Durchgang, danach gesondert: JoJo bei Prime (Daniel, 19.09.2026)** | 3 | `amazon.de/dp/B0CG7S59KL` ist die JoJo-Sammelseite mit „7 Staffeln“; das Auswahlfeld führt Staffel 1–3 doppelt (mit und ohne Kanal-Symbol) plus Staffel 4, und „Staffel 2“ ohne Symbol hat keine Folgen. Vor dem gemeinsamen Durchgang recherchiere ich die Zuordnung Prime-Staffel → AniList-Teil (Phantom Blood/Battle Tendency, Stardust Crusaders 1+2, Diamond is Unbreakable, Golden Wind, Stone Ocean) und lege sie ihm in einem Satz je Staffel vor. |
