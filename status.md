...
| Aufgabe | SP | Notiz |
|---|---|---|
| **Crunchyroll aus deutscher Sicht abrufen** | 5 | **Der Lauf vom 21.08.2026 hat US-Daten geliefert** — alle 1.655 geprüften Folgen in 592 archivierten Serien tragen `eligible_region: "US"`, weil GitHub-Runner in den USA stehen. Folge: Ein `de-DE` in `versions` bleibt ein Beleg (226 Serien, Kontrollgruppe 24/24), ein **fehlendes** belegt nichts — „Fairy Tail" hat in Deutschland 277 deutsche Folgen und in der US-Antwort keine. Ebenso die Verfügbarkeit: „Dragon Ball" und „Dragon Ball Z" liefern volle Folgenlisten, während die deutsche Seite das Banner zeigt. **Zu klären ist der Weg zur deutschen Sicht** (Reihenfolge: Regionsparameter der Schnittstelle, angemeldeter Zugang mit Daniels Konto, Lauf von seinem Rechner, Proxy) — das ist eine Entscheidung, keine Fleißarbeit |
