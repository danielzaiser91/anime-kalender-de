...
| **Netflix: Stichprobe auch für Prüflisten-Aufträge** | 2 | Daniel, 13.09.2026, bei Konosuba S2 (Auftrag E1–10, Knopf prüfte alle zehn einzeln): „warum wird jede einzelne episode geprüft statt von bis prüfung und assume alles dub?“ Entschieden per Dialog: auch ein Auftrag mit mehr als zwei Folgen prüft erste und letzte Folge; stimmen beide überein, gilt der Rest als Annahme (randMelden), sonst erscheint das Grenzfeld. Stelle: Knopftext und Ablauf in extension/melder.js (Zweig auftrag in durchlaufKnopfZeigen, Randprobe nur bei offen > 2 ohne Auftrag). **Präzisiert von Daniel am selben Abend:** Stichprobe nur, wenn die Folgenzahl der Netflix-Staffel zu unserer Erwartung passt (Summe unserer Titel in dieser Staffel laut anbieter-gerechneter Prüfliste, bei einer laufenden Staffel nur die bereits erschienenen Folgen). Zeigt Netflix mehr Folgen, ist eine OVA eingemischt oder die Staffel läuft noch: dann jede Folge einzeln melden, die OVA sortiert später die Zuordnung über die Folgentitel heraus. Kommt nach dem Durchgang dran |
| **Disney+: Prüflisten-Dialog überdeckt den Kasten** | 1 | Daniel, 13.09.2026, 19:55, mit Bild: Klick auf den Prüflisten-Knopf öffnet den leeren Dialog „Alles gemeldet · Übernahme ab 20:23“, und der Kasten der Erweiterung liegt über dessen unterer rechter Ecke. Nach dem Durchgang mit npm run check:disney-kasten (Dialog offen) nachstellen und Abstand bzw. Stapelreihenfolge richten |
| **Crunchyroll-Lauf: zwei Lücken aus dem Durchgang schließen** | 2 | Daniel, 13.09.2026, 20:01: „warum funktioniert der crunchylauf nicht? eig müsste der crunchylauf doch alle crunchy fragen selbst klären“. Zwei der ersten zwei Handantworten hätte der Lauf selbst finden können: (1) **Specials in der Hauptserie** — Durarara führt bei Crunchyroll 25 Folgen = Serie 24 + ein Special; eine Folgenzahl, die genau um die Specials der Reihe über der Serie liegt, belegt die Specials mit. (2) **Alte Adressen ohne Serienkennung** (Sin: The Movie, Cencoroll, Your Voice, Okko) — die heutige Adresse hat eine Kennung (Sin: GMTE00192533), die content/v2/discover/search mit type=movie_listing liefert; ohne Kennung kann der Lauf nichts messen. (3) **Eine OVA mit eigenem OmU-Block kann im Dub-Block der Staffel synchronisiert stecken** — Chunibyo Heart Throb: Block „(OVA)“ nur Untertitel, der Lauf buchte Nein; im Block „(German Dub)“ steht dieselbe Folge als S2 E13 mit Synchro. Vor einem Nein zu einer OVA die Dub-Blöcke derselben Serie nach gleichnamiger Folge durchsuchen. (4) **Altadressen der Form …-unbekannt-NNNNNN sind tot** (Cencoroll, Your Voice: beide 404) — als tot werten und über die Suche die heutige Serienkennung holen. Nach dem Durchgang: Suche nach movie_listing für Filme ohne Kennung einbauen, Specials-Summe in die Zuordnung |
| **Okko und ihre Geisterfreunde: drei Bezugswege eintragen** | 1 | Daniel, 13.09.2026, 20:16, selbst gefunden: maxdome Kauf 19,99 € / Leihe 4,99 € (https://store.maxdome.de/mo45189120), Blu-ray bei Amazon 29,99 € (https://www.amazon.de/Okko-ihre-Geisterfreunde-Film-Blu-ray/dp/B07X5R7M5P), Apple TV (https://tv.apple.com/de/movie/okko-und-ihre-geisterfreunde/umc.cmc.3eqc4wjpue1fsa43ukgmcwt7i, zeigt ein Prime-Video-Symbol). Für später: als Verweise an Titel 101478 hängen, Sprachfassung je Weg offen lassen |
| **Recherche: Anbieterketten (Apple TV → Prime → Crunchyroll-Kanal)** | 2 | Daniel, 13.09.2026, 20:16: Okko ist bei crunchyroll.com nicht mehr verfügbar, läuft aber im Crunchyroll-Kanal auf Prime, und Apple TV zeigt dafür ein Prime-Symbol. Fragen: Was passiert mit den vorderen Kettengliedern, wenn ein hinteres einen Titel aus dem Katalog nimmt? Kann man auf Prime Crunchyroll-Titel weiter streamen, die bei Crunchyroll rausgeflogen sind? Beschweren sich Nutzer über solche Fälle? Ergebnis als .md, mit Websuche. Für später |
| **Erweiterung: Prime-Meldung trägt „Chatverlauf“ als Titel** | 1 | 13.09.2026, zweimal hintereinander (Meldungen 4417 Okko, 4418 Danganronpa 3): Der Titel stammt aus Amazons Seitentext statt aus dem Auftrag, titel_id bleibt leer, die Meldung ist nicht zuordenbar. Am 09.09.2026 schon einmal bei Death Note Relight aufgefallen. Fix: Titel und titel_id aus dem gemerkten Suchauftrag übernehmen; Zusicherung dazu |
| **Shakugan no Shana Staffel 2 bei Prime: „kein Deutsch“ trotz deutscher Besetzung** | 1 | Daniel, 13.09.2026, 20:29, mit Bild: B0CMZZVV7R, „In Prime enthalten“ (kein Kanal), Staffel 2 mit 24 Folgen, der Kasten zeigt „kein Deutsch · 24 Folgen“, die Seite nennt als Besetzung Samina König, Tim Schwarzmaier, Ingo Albrecht. Nicht gemeldet. Klären, ob die Besetzung nur Staffel 1 gilt oder die Erweiterung falsch liest (Bericht der Seite ansehen) |
| **Erweiterung: kein Melde-Knopf auf der Titelseite eines Suchauftrags** | 1 | Daniel, 13.09.2026, 20:31, mit Bild: The Ghost in the Shell, B0GZD5N2GP (die Seite, die aniSearch nennt, von der Suchadresse aus geöffnet). Der Kasten zeigte nur „1 Prime-Titel · 1 Suchen offen“, keinen Befund und keinen Melde-Knopf. Bei Saekano und Shana erschien der Knopf; Unterschied vermutlich: Seite über den aniSearch-Link statt über einen Suchtreffer geöffnet, der Suchauftrag reist dann nicht mit. **Zweiter Fall 20:34, mit Bild:** Vom Landei zum Schwertheiligen II, B0H1QXQL33, ebenfalls über den aniSearch-Link geöffnet, „In Prime enthalten“ (kein Kanal). Kopfzeile „meldet: Vom Landei zum Schwertheiligen · B0H1QXQL33“ steht, die Melde-Zeile darunter ist leer: weder Befund noch „gemeldet ✓“. Diagnosebericht dieser Seite: docs/diagnose/landei-2-kein-meldeknopf.json. Nachstellen und beheben |
| **aniSearch-Adresse statt Prime-Suchadresse** | 2 | Daniel, 13.09.2026, 20:36: „wenn anisearch links funktionieren, dann sind sie besser als unsere links zur suchseite.“ Anlass: The Ghost in the Shell (B0GZD5N2GP) und Vom Landei zum Schwertheiligen II (B0H1QXQL33), beide Adressen aus aniSearch, beide richtig und deutsch. Bisher bleiben sie als Frage in 18-suchadressen.md liegen, weil hinter /dp/ auch eine DVD stehen kann. Umbau: nennt aniSearch zu einer Suchadresse eine Amazon-Adresse und belegt der Link-Check sie als Prime-Video-Seite (Merkmal av-detail-section oder „| Prime Video“ im Titel), ersetzt sie die Suchadresse ohne Rückfrage |
| **Erweiterung: Chip „2 erwartet“ unter den angekreuzten Treffern umbenennen** | 1 | Daniel, 13.09.2026, 20:38, mit Bild (Plus-Sized Elf, zwei angekreuzte Ausgaben B0DY17414W und B0DJM2FGH6): „warum steht da 2 erwartet, statt ausgewählt (oder sonstiges bestätigungs-label für die checked treffer)?“ Der Chip meint die im Briefkasten gespeicherte Auswahl. Kurzer, klarer Text, zum Beispiel „2 ausgewählt“, und nach dem Melden „1 von 2 gemeldet“ |
| **Trinity Seven trägt die Prime-Adresse von Plus-Sized Elf** | 1 | Daniel, 13.09.2026, 20:40, mit Bild: B0DY17414W ist „Plus-Sized Elf – Staffel 1“ (In Prime enthalten, 14 Folgen deutsch laut Kasten), der Kasten schrieb aber „meldet: Trinity Seven: Heavens Library & Crimson Lord · B0DY17414W“, und die Kanal-Wiedervorlage in offene-amazon.js führt Trinity Seven unter genau dieser ASIN. Nicht gemeldet. **Berichtigt im Durchgang (20:41):** Der Beleg vom 10.09.2026 (Deutsch, 14 Folgen, B0DY17414W) hing an 103631 und ist auf Plus-Sized Elf (173388) umgebucht. Offen bleibt, warum die Erweiterung den Titel der Seite als Trinity Seven liest — vermutlich aus der Kanal-Wiedervorlage in offene-amazon.js, die dieselbe ASIN trägt |
...
| **5 Kanal-Meldungen, denen JustWatch widerspricht** | 2 | `pipeline/kanal-gegenprobe.ts` (neu am 09.09.2026) macht aus 39 Kanal-Meldungen ohne Urteil **18 belegte Nein** — Prime fiel damit von 29 auf 11 Verweise ohne Sprachurteil. Bei **fünf** findet JustWatch dagegen deutschen Ton (Date a Live II, Trinity Seven, Touken Ranbu, Bungo Stray Dogs, Digimon): Die Kanal-Meldung war ein Falschnegativ, wie CLAUDE.md es beschreibt (ohne Kanal-Abo fehlt die deutsche Tonspur in Amazons Anzeige). Ein **positives** Urteil entsteht daraus bewusst nicht — JustWatch sagt „irgendwo deutsch", nicht „bei diesem Anbieter deutsch". Diese fünf brauchen einen Blick mit Kanal-Abo oder eine dritte Quelle |
