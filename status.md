...
| **Zu besprechen (Daniel, später): zwei gleich aussehende Prime-Pillen** | 1 | Stichprobe 17.09.2026: 15 Titel (u. a. 5460 „Der nachtschwarze Jäger", 2994, 20464, 100745) zeigen zwei Prime-Pillen mit derselben Beschriftung und Zugangsart — zwei Kauf- oder Abo-Ausgaben unter verschiedenen ASINs. Für den Leser ist nicht erkennbar, was sie unterscheidet. Möglich: zusammenlegen, „Ausgabe 2" anhängen, oder die Erweiterung schickt Verlag/Band mit, damit die Pille es nennen kann. |
| **Zu besprechen (Daniel, später): „DE nur Fg. 1" bei Stichproben-Belegen** | 1 | Stichprobe 17.09.2026: „Monster" (74 Folgen) zeigt „Netflix ✓ DE nur Fg. 1", weil der Netflix-Beleg nur Folge 1 geprüft hat. Die Wendung stammt von Date a Live auf YouTube (dort gibt es wirklich nur Folge 1, 07.09.2026). Frage: Bei einem Anbieter, der erkennbar die ganze Staffel führt, lieber „Fg. 1 ✓" (wie „Fg. 11" bei Dr. Stone) statt „nur"? Aus dem Beleg allein ist der Unterschied nicht ablesbar. **Gezählt am 17.09.2026:** 16 Netflix-Verweise (u. a. Monster, Frieren, Made in Abyss, Pluto, Yū Yū Hakusho) und 3 YouTube-Verweise tragen nur einen Beleg für Folge 1 — bei Netflix sind das die Einzelmeldungen der ersten Folge, bei YouTube ist es tatsächlich nur Folge 1. |
...
| **Offen (Daniel, 17.09.2026, 20:02): Your Name — sechs Befunde an einem Titel** | 5 | (1) **Falsche TMDB-Zuordnung:** Titel 21519 trägt `tmdbId` 398818 = „Call Me by Your Name" — unser Name steckt als Teilstück im längeren fremden Titel. Folgen: falsche Handlung, Apple-TV/Google-Play/YouTube/MagentaTV/Videoload-Pillen zeigen auf die TMDB-Seite des falschen Films, und JustWatch findet den Titel nicht (Kennung passt nicht). Stichprobe über 150 Zuordnungen: 7 auffällig, davon 6 in Wahrheit richtig (TMDB führt den Originaltitel). (2) **„Streamstart noch nicht bekannt"**, obwohl Prime, YouTube, Rakuten und maxdome verlinkt sind. (3) **YouTube-Pille führt auf den Trailer** statt auf den Kauf-Stream (dafür gibt es den Trailer-Knopf). (4) **Prime-Link tot** (`B0FLLFC2L6`) — prüfen, ob der nächste Linklauf ihn fängt. (5) **maxdome hat nachweislich deutsche Synchro** — Pille steht auf „DE ?". (6) **Wiederaufführung kennzeichnen:** Der Film lief 2016 schon im Kino und läuft am 29.09. erneut; dafür ein eigenes Kennzeichen. |
| **Offen (Daniel, 17.09.2026, 20:02): Kino-Banner im Detail-Panel** | 3 | Statt der Kino-Pille ein gestalteter Banner zwischen Trailer-Zeile und Antwort-Kasten (Kasten rutscht nach unten): Startdatum, Zeitraum, Sender/Kinokette, Merken-Knopf darin. Design frei, visuell ansprechend. Gilt für laufende und kommende Kinofilme. |
