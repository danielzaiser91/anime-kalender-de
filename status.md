...
3a. **RTL+ als eigener Wochentermin:** Beyblade X Staffel 3 erscheint freitags auf RTL+ auf Deutsch (F1 05.06. bis F17 18.09.2026), der Kalender kennt das nicht. Braucht ein offenes Ende wie `tvLetzteSichtung` (Folgenzahl der Staffel unbekannt, nichts erfinden) und `dubRanges` am RTL+-Weg aus den Folgen.
