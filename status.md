...
| **11 Crunchyroll-Verweise ohne Urteil — der Rest ist gemessen hart** | 2 | Stand 10.09.2026, 08:40: von 28 auf 11. **Die Differenz zwischen Lauf und Datensatz war der Fund:** Der Lauf meldete 17 offen, der Datensatz zeigte 28 — und keine dieser Adressen war ihm unbekannt. Drei Stellen wandten seine Befunde nicht an (tote Adressen wurden nur gezählt, die Nachrunde legte sie neu an, und ihre Urteile las niemand). Alle drei sind behoben, die Lehre steht in CLAUDE.md. **Was bleibt:** 4 Adressen, die JustWatch nicht kennt (keine zweite Quelle), 3 Reihen-Verweise ohne Angebote bei JustWatch, 2 mehrdeutige Staffeln (Sound! Euphonium, Chunibyo — zwei Staffeln gleichen Namens mit gleicher Folgenzahl), 2× Rascal (Video ja-JP, aber die Serie führt Deutsch — eine andere Fassung kann es geben). Alle vier Gruppen brauchen einen Blick von Hand oder eine Quelle, die es nicht gibt |
