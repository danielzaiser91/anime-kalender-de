...
| Aufgabe | SP | Notiz |
| ADN-Katalog: Zuordnung zu AniList prüfen | 2 | `data/adn-catalog.json` ordnet 882/904/924 (One-Piece-Filme) fremden AniList-Titeln zu (18617 Girls und Panzer der Film, 8184, 2679), gemessen 21.09.2026. Ohne gemeinsames Titelwort: 29 von 117 Katalogeinträgen, meist nicht im Bestand. Zu prüfen: die Namenssuche in `fetch-adn.ts`, und ob ein falscher Eintrag einem Bestandstitel einen fremden ADN-Weg gibt (`katalogKennung` in `build.ts`). |
