...
| Frage | Messung |
|---|---|
| Worker-Ziele je Staffel statt je Adresse abziehen? | 22.09.2026: `worker/src/index.ts` (`?stand=1`) streicht ein Ziel, sobald unter seiner Adresse **irgendetwas** nach `pruefstand.erzeugtAm` gemeldet wurde. Dr. STONE verschwand nach der Meldung von Staffel 1 aus der Prüfliste, obwohl Staffel 2 offen war; Haikyu!! ebenso. Löst sich mit jeder Übernahme von selbst. Umbau: Prüfstand schickt je Ziel die offenen Netflix-Staffeln, Worker vergleicht mit `pruefung.staffel`, Worker-Deploy. |
