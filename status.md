...
| **In Arbeit: TV-Ausstrahlungen als eigene Termine** | 5 | Daniel, 16.09.2026, an Dragon Ball Daima (TOGGO plus, Mo–Fr 21:15 ab 28.08., 20 Folgen): „tägliche tv releases sind ein paradebeispiel für eine notwendige erweiterung der webseite um genau das darzustellen". Bisher kennt der Datensatz keinen Sender als Anbieter; der TV-Start stand nur als Hinweis am RTL+-Termin. Zuerst: Quellen für deutsche Sendetermine (fernsehserien.de, Senderseiten) und das Datenmodell (Sender, täglicher Takt) |
| **Offen: Bluelock — Amazons Staffel 2 (24 Folgen, `B0BZYQSDN8`) am Reihenkopf** | 1 | Unsere Staffel 2 hat 14 Folgen; ob die Seite Staffel 1 ist, steht nicht fest. Braucht einen Blick auf die Seite (Daniel) |
