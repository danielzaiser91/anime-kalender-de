...
| **Morgen (17.09.2026) bei „weiter“: Daniels Antworten vom 17.09., 00:11, abarbeiten** | 3 | (1) Capsule-Monsters-Suche als „nicht bei Prime“ gemeldet → danach stand „gemeldet ✓“, aber die Vorschläge (Deutsch/Englisch suchen, Zur Reihe springen) blieben stehen, und „gemeldet“ war nicht grün. Beides prüfen: Vorschläge nach Meldung ausblenden, „gemeldet“ grün wie auf Titelseiten. (2) Bluelock `B0BZYQSDN8`: Link führt auf Amazons Staffel 1 mit 24 Folgen, Staffel 2 im Auswahlfeld hat 14 Folgen, alle deutsch → Zuordnung: Seite = unsere Staffel 1, Staffel 2 (14) = unsere Staffel 2, beide dub true (Meldungen prüfen/verbuchen). (3) Kuroko S1 gemeldet → Knopf zeigte „gemeldet ✓“ statt „weiter mit Staffel 2“, obwohl das Auswahlfeld S2 anbietet und die offen war; S2 ließ sich melden (beide gemeldet). Wunsch: Knopf kennt die Staffeln des Auswahlfelds und bietet die nächste offene an. Golden Kamuy: Liste sagt „S1 E1–12 gemeldet“, Knopf bot trotzdem „melden“ an — klären, ob gewollt (Kanal-Meldung = Wiedervorlage?) und Anzeige angleichen. Daniel hat **alle Titel der Liste inkl. aller Staffeln gemeldet** → im Briefkasten prüfen, ob alles korrekt angekommen ist (Staffeln, Kennungen, Folgen). (4) Fruits Basket `B0G6HF46PV` ohne Kanal-Buchung gemeldet. Daniels Frage: Die Info sollte doch unabhängig von der Kanal-Buchung sein? → prüfen, was die Meldung ohne Abo enthält (Amazon zeigt dann nur zugängliche Tonspuren, siehe CLAUDE.md „Bei einem Kanal-Titel ist Amazons Sprachangabe kein Beleg“), und Daniel die Antwort geben. (5, 00:13) Suchtreffer-Checkliste (Schleim, `B0CJC11GRB`): „weiter mit Staffel 3“ klappt, aber nach dem Staffelwechsel ist der Treffer, von dem man kam (`B0CGWV6RK8`), in der Checkliste nicht mehr hervorgehoben — alle Staffeln unter demselben Suchtreffer sollen dazugehören und das Highlight auslösen; dazu erscheint „Andere Seite als der Treffer aus der Suche — vor dem Melden prüfen“ zu Unrecht. **Details aus Daniels Bildern (Bilder selbst sind nicht aufbewahrt):** Capsule-Suche: Kasten „Yu-Gi-Oh! Capsule Monsters · 12 Folgen / Nicht dieser Titel — gefunden: Yu-Gi-Oh! / Prime führt nur den Reihennamen“, Knöpfe „Deutsch suchen“, „Englisch suchen“, „Zur Reihe springen: Yu-Gi-Oh! (B07DRNBLNP)“, nach Meldung grauer Knopf „gemeldet ✓“, Vorschläge blieben. Kuroko: S1 `B09P9P9YG6` (Kauftitel, 2 Staffeln) nach Meldung „gemeldet ✓“; S2 `B09ZJW8HGH?ref_=atv_dp_season_select_s2` zeigte „DE Deutsch · 25 Folgen · Staffel 2 · nur Kauf · melden“; Leiste „8 Prime-Titel · 4 Suchen offen“. Golden Kamuy `0QG5UD99TZDIAQSBIEJD3EXG2Y` (Crunchyroll-Kanal): Knopf „DE Deutsch · 12 Folgen · Staffel 1 · ⚠ Kanal · melden“, Prüfliste gleichzeitig „S1 E1–12, S2, S3 +2 gemeldet“; Liste zeigte 5 Prime-Titel (Golden Kamuy, Kizuna no Allele, Solo Leveling „S1 E1–13 gemeldet“, Trapped in a Dating Sim, Vinland Saga) und „Suche nötig — 4 von 5 offen“ (Schleim 24 Folgen, Saint’s Magic Power 12, Wind Breaker 13, Arifureta OVAs 2 „wackelig“). Schleim S2 `B0CJC11GRB`: Kasten „24 Folgen erwartet“, Checkliste ✓ `B0CGWV6RK8`, ○ `B0F1Z6FJFQ`, darunter „Nicht bei Prime — melden“, dann **zwei** grüne Knöpfe übereinander: „✓ Staffel 2 gemeldet · weiter mit Staffel 3“ und „gemeldet ✓“ (Dopplung prüfen). **Import der Nachtmeldungen (17.09., 09:55) schon auffällig:** 3 Belege am Reihenkopf umgehängt (Trapped S2, Schleim S3/S4), Import-Fix gepusht. Noch falsch in `dub-confirmed.yaml`: Golden Kamuy — Seite B0CJYLSY3D (Staffel 4, 13 Folgen) liegt als Folgen 1–12 an 99699 und Folge 1 an 102977, gehört an 142343 (Golden Kamuy 4); Schleim — Seite B0CJC11GRB (Staffel 2, 24 Folgen) liegt auch an 116741 (Schleim-Tagebücher, Beiwerk), gehört an 108511 + 116742; übrige Meldungen dieser Nacht einzeln gegenprüfen |
| **Offen: Berserk (2017) Staffel 2 und Our Last Crusade Staffel 2 stehen nicht im Bestand** | 1 | Belege mit Deutsch liegen jetzt an 97643 und 139825; beide Titel fehlen in MyDubList und im Katalog. Aufnahme über `synchro-von-hand.yaml` braucht zwei Quellen — Suche am 16.09. ohne klaren zweiten Beleg |
...
| **Amazon-Suchseite: bestätigte Auswahl erscheint in einem neuen Tab nicht — Fix gebaut (4.20.21), Gegenprobe beim nächsten Suchauftrag** | 1 | 15.09.2026, 21:20: Ursache im Code gefunden — der Suchkasten wird nur bei neuer Adresse oder Folgenzahl neu gezeichnet; kam die Auswahl vom Worker nach dem ersten Zeichnen, blieb die Vorauswahl stehen (Wettlauf, beim Neuladen zufällig richtig). Jetzt löst das Eintreffen der Auswahl ein Neuzeichnen aus. | Stand 15.09.2026, 21:02: nicht nachstellbar. Der Auswahlkasten erscheint nur bei einem offenen Suchauftrag, und die Prime-Liste führt nur noch eine Titelseite (Fruits Basket). Sobald wieder eine Suche mit zwei Ausgaben ansteht: dort bestätigen, „zurück" per mittlerer Maustaste, „Bericht laden". | Stand 15.09.2026, 12:35: `erwartungsAuswahl()` liest die Auswahl aus `erwartungZu()` (Worker), beim ersten Zeichnen ist die Antwort noch nicht da; warum das nur im neuen Tab und nicht beim Neuladen stehen bleibt, sagt der Code nicht. Die Notiz verlangt Messen vor dem Fix: Daniel öffnet die Suche per mittlerer Maustaste auf „zurück" in einem neuen Tab und lädt dort „Bericht laden". | Daniel am 15.09.2026, 10:39, mit Bild: Touken Ranbu, Auswahl `B0FQXKKXQW` bestätigt, dann „zurück" mit mittlerer Maustaste in einem neuen Tab → beide Ausgaben angehakt, Knopf „Auswahl bestätigen" statt „1 ausgewählt". Beim Worker ist die Auswahl gespeichert (`erwartungen[…Touken…] = ["B0FQXKKXQW"]`, geprüft 10:40). Laut `erwartungsAuswahl()` soll sie von dort kommen — die Anzeige liest sie in diesem Fall nicht. **Gegenprobe 10:41 (Bild):** Ein Neuladen im selben Tab zeigt es richtig — nur `B0FQXKKXQW` angehakt, „1 ausgewählt". Der Fehler hängt also am Öffnen im neuen Tab (Verdacht: erstes Zeichnen vor der Briefkasten-Antwort ohne Neuzeichnen, oder ein Zustand aus dem `sessionStorage` des alten Tabs). Erst messen. Wartet bis nach dem Durchgang |
