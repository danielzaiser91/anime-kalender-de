...
import { loadCurated, loadWatchLinks } from './lib/curated.ts'
...
import {
  PLATFORM_PRIORITY, amazonSearchUrl,
  anisearchPlatform,
  providerKind,
  providerName,
  stripAffiliate, ANILIST_COVER_BASIS,
  FRANCHISE_RELATIONS,
  otherZaehlt
} from '../shared/mappings.ts'
import { kinoFeld, anisearchHand, verpassteTermine, OUT, mitAnkuendigung, VOICES_DIR, CR_CALENDAR_URL, ADN_CALENDAR_URL, NEIN_GILT_TAGE, type EntfernterVerweis } from './bau/grundlagen.ts'
import { schreibeSuchadressen, schreibeCartoons, schreibeOhneSynchro, quellenPflegen, schreibeMeldungen, schreibeNeuMitSynchro } from './bau/nebendateien.ts'
import { fskFromAdnAge, adnSlug, adnBlockName, werkTitel, adnHinweis, isoDate, isoDatumGenau, titleFromMedia, providerToPlatform, overlapsWindow, derivedStart, observedEpisodes, pickPlatformUrl } from './bau/titel-hilfen.ts'
