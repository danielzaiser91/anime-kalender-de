...
export const TEXTE_KALENDER = {
  ...
  'kal.monatZahlen': '{stream} Streaming-Termine · {tv} im TV',
  'kal.monatZahlenOhneTv': '{stream} Streaming-Termine',
  'kal.tagZahlen': '{stream} Stream · {tv} TV',
  'kal.tagZahlenOhneTv': '{stream} Stream',
  'kal.keinStream': 'Kein Streaming-Termin an diesem Tag.',
