  ...
  return (
    <span
      className={[
        ...
        'bg-(--pl-bg) text-(--pl-text) shadow-[inset_0_0_0_1px_var(--pl-rand)]',
        'dark:bg-(--pl-voll) dark:text-(--pl-voll-text) dark:shadow-none',
        PLAKETTE_GROESSE(small),
      ].join(' ')}
      style={plakettenStil(p.color) as React.CSSProperties}
    >
